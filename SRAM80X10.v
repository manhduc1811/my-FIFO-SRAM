...
//      version:		2007Q1V1
//      comment:		
//      configuration:	 -instname SRAM80X10 -words 80 -bits 10 -frequency 1 -ring_width 5 -mux 4 -drive 12 -write_mask off -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND -asvm off
//
//      Verilog model for Synchronous Single-Port Ram
//
//      Instance Name:  SRAM80X10
//      Words:          80
//      Word Width:     10
//      Pipeline:       No
//
//      Creation Date:  2020-12-04 02:52:00Z
//      Version: 	2007Q1V1
//
